...
interface TaskOutputBlockProps {
    content: ToolContent;
    messageId: string;
    vscode?: any;
}
...
const TaskOutputBlock: React.FC<TaskOutputBlockProps> = ({ content: toolContent, messageId, vscode }) => {
...
export default React.memo(TaskOutputBlock);
